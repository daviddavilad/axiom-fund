"""Full historical backtest runner — NO-RESMOM VARIANT.

Runs a 3-signal variant of the Axiom Fund strategy: GP + IVol + PEAD
(without Residual Momentum). The IC analysis showed ResMom has zero
predictive power (t=0.26, p=0.80) over the 116-period window; this
variant tests whether dropping ResMom changes realized returns.

Compare results to:
  data/cache/backtest_full_top1000/         (3-signal, GP+IVol+ResMom)
  data/cache/backtest_full_top1000_4sig/    (4-signal, +PEAD)
  data/cache/backtest_full_top1000_no_resmom/ (this run, GP+IVol+PEAD)

Outputs to data/cache/backtest_full_top1000_no_resmom/:
...
Estimated runtime: 50-60 minutes for ~116 monthly periods.
"""
# ruff: noqa: I001
...
RISK_AVERSION = 1.0
HOLDING_DAYS = 21
CACHE_DIR = Path("data/cache/backtest_full_top1000_no_resmom")
